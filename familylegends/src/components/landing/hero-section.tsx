          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Link href={communitySettings?.discordInviteLink || 'https://discord.gg/familylegends'} target="_blank" className="flex items-center justify-center gap-3 w-full h-full">
